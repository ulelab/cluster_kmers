...
def cli():
    parser = argparse.ArgumentParser(description='Cluster k-mers based on sequence or on a combination of sequence and enrichment in CLIP data.')
...
def run(kmers, cluster_on='seq', n_clusters='auto', peka_files=None, results_folder='.', min_token_len=1, weblogos=True, consensus_length='auto'):
    """
